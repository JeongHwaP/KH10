...
public class GuestBookController {
	...
	public String list() {
		...
		List<GuestBookDto> data = jdbcTemplate.query(sql, GuestBookDto.getMapper());
	...
	public String search(@RequestParam String type, @RequestParam String keyword) {
		if (type.equals("name")) {
			...
			List<GuestBookDto> data = jdbcTemplate.query(sql, GuestBookDto.getMapper(), param);
	...
	@ResponseBody
	public String search3(@RequestParam String type, @RequestParam String keyword) {
	...
	@ResponseBody
	public String search4(@RequestParam String type, @RequestParam String keyword) {
...
//			@RequestParam String name, @RequestParam String memo) {
